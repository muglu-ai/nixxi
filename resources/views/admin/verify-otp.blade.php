...
<head>
    ...
    <title>Admin OTP Verification | {{ config('app.name', 'Laravel') }}</title>
            ...
            <div class="col-md-5">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.login.verify.otp') }}" id="otpForm">
                            @csrf
                            ...
                            <div class="text-center">
                                <form method="POST" action="{{ route('admin.login.resend-otp') }}" class="d-inline">
                                    @csrf
