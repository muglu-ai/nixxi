            ...
            <div class="modal-body">
                ...
                @else
                            ...
                            <div class="row">
                                @if(!empty($ixDocuments))
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <a href="{{ \Illuminate\Support\Facades\Storage::url($path) }}" target="_blank" class="btn btn-sm btn-outline-primary">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <a href="{{ \Illuminate\Support\Facades\Storage::url($ixData['pdfs']['application_pdf']) }}" target="_blank" class="btn btn-primary">
