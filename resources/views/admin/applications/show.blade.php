                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="list-group list-group-flush">
                                        ...
                                        <div class="list-group-item px-0 py-2 small">
                                            ...
                                            <form method="POST" action="{{ route('admin.applications.invoice.mark-paid', $invoice->id) }}" class="mt-2">
                                                @csrf
                                                <div class="row g-2 align-items-end">
                                                    <div class="col-md-4">
                                                        <label class="form-label small mb-1">Payment ID</label>
                                                        <input type="text" name="payment_id" class="form-control form-control-sm" required placeholder="Reference / UTR">
                                                    </div>
                                                    <div class="col-md-5">
                                                        <label class="form-label small mb-1">Notes (optional)</label>
                                                        <input type="text" name="notes" class="form-control form-control-sm" placeholder="Any remarks">
                                                    </div>
                                            ...
                                            @elseif($invoice->status === 'paid' && $invoice->manual_payment_id)
                                            <div class="mt-1 text-success">
                                                Manual Payment ID: {{ $invoice->manual_payment_id }}
                                            </div>
                                            @endif
                                        </div>
                                        @endforeach
