        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link position-relative" href="{{ route('admin.grievance.index') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16" class="me-1">
                    ...
                    <li class="nav-item">
                        <a class="nav-link position-relative" href="{{ route('admin.plan-change.index') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16" class="me-1">
                                <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                            ...
                            @if($pendingPlanChanges > 0)
                                <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-warning text-dark" id="planChangeBadge">
                                    {{ $pendingPlanChanges }}
                                </span>
                            @endif
                        </a>
                    </li>
                    @if(isset($currentAdmin) && $currentAdmin->hasRole('ix_account'))
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.applications.payment-allocation.form') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16" class="me-1">
                    ...
                    <li class="nav-item">
                        <form method="POST" action="{{ route('admin.logout') }}" class="d-inline" id="logoutForm">
                            @csrf
                            <a href="#" class="nav-link" onclick="event.preventDefault(); if(confirm('Are you sure you want to logout?')) { document.getElementById('logoutForm').submit(); }" style="color: #dc3545 !important;">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16" class="me-1">
