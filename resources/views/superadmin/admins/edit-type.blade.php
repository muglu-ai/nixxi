...
<div class="container-fluid py-4">
    ...
    <div class="mb-4">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2 class="mb-1" style="color: #2c3e50; font-weight: 600;">Edit Admin Type</h2>
        ...
        <div class="col-md-8">
            <div class="card border-0 shadow-sm" style="border-radius: 16px;">
                <div class="card-header bg-warning text-dark" style="border-radius: 16px 16px 0 0;">
                    <h5 class="mb-0" style="font-weight: 600;">Admin Roles / Types</h5>
                </div>
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="{{ route('superadmin.admins.update-type', $admin->id) }}">
                        @csrf
                        ...
                        <div class="mb-3">
                            <button type="submit" class="btn btn-warning px-4 py-2" style="border-radius: 10px; font-weight: 500;">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="me-2" viewBox="0 0 16 16">
