...
<head>
    ...
    <title>IX Application Live - IP Assigned</title>
                ...
                <table role="presentation" style="max-width: 600px; width: 100%; background-color: #ffffff; border: 10px solid #27ae60; border-radius: 4px; overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 25px 30px; border-bottom: 2px solid #27ae60; background-color: #27ae60;">
                            <p style="margin: 0; color: #ffffff; font-size: 22px; font-weight: 600; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">🎉 IX Application is Now Live!</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="margin: 0 0 25px 0; color: #555555; font-size: 15px; line-height: 1.6; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">
                                Congratulations! Your IX application is now live. IP has been assigned and your membership details have been generated.
                            </p>
                            ...
                            <div style="background-color: #f8f9fa; border-radius: 6px; padding: 25px; margin: 30px 0; border: 1px solid #e0e0e0;">
                                ...
                                <table role="presentation" style="width: 100%; border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <td style="padding: 8px 0; color: #555555; font-size: 14px; font-family: 'Nunito', 'Trebuchet MS', sans-serif;"><strong>Assigned IP:</strong></td>
                                        <td style="padding: 8px 0; color: #27ae60; font-size: 14px; font-weight: 600; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">{{ $assignedIp }}</td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 8px 0; color: #555555; font-size: 14px; font-family: 'Nunito', 'Trebuchet MS', sans-serif;"><strong>Customer ID:</strong></td>
                                        <td style="padding: 8px 0; color: #2c3e50; font-size: 14px; font-weight: 600; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">{{ $customerId }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 8px 0;">
                                            <span style="background-color: #27ae60; color: #ffffff; padding: 4px 12px; border-radius: 12px; font-size: 12px; font-weight: 600; text-transform: uppercase; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">Live</span>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div style="background-color: #e8f8f0; border-left: 3px solid #27ae60; padding: 15px; margin: 20px 0; border-radius: 4px;">
                                <p style="margin: 0; color: #155724; font-size: 13px; line-height: 1.5; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">
                                    <strong>Important:</strong> Your membership invoice and IX invoice have been attached to this email. Please keep these documents for your records.
                                </p>
                            </div>
