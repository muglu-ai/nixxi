...
<head>
    ...
    <title>IX Application Submitted</title>
        ...
        <tr>
            <td align="center" style="padding: 30px 20px;">
                <table role="presentation" style="max-width: 600px; width: 100%; background-color: #ffffff; border: 10px solid #2c3e50; border-radius: 4px; overflow: hidden;">
                    <!-- Header -->
                    <tr>
                        <td style="padding: 25px 30px; border-bottom: 2px solid #2c3e50; background-color: #2c3e50;">
                            <p style="margin: 0; color: #ffffff; font-size: 22px; font-weight: 600; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">IX Application Submitted</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="margin: 0 0 25px 0; color: #555555; font-size: 15px; line-height: 1.6; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">
                                Your IX application has been successfully submitted and payment has been received. Your application is now under review by our IX Application Processor team.
                            </p>
                                ...
                                <table role="presentation" style="width: 100%; border-collapse: collapse;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 8px 0;">
                                            <span style="background-color: #f39c12; color: #ffffff; padding: 4px 12px; border-radius: 12px; font-size: 12px; font-weight: 600; text-transform: uppercase; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">Under Review</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 8px 0; color: #555555; font-size: 14px; font-family: 'Nunito', 'Trebuchet MS', sans-serif;"><strong>Submitted At:</strong></td>
                                        <td style="padding: 8px 0; color: #2c3e50; font-size: 14px; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">{{ $application->submitted_at ? $application->submitted_at->format('d M Y, h:i A') : 'N/A' }}</td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div style="background-color: #e8f4f8; border-left: 3px solid #3498db; padding: 15px; margin: 20px 0; border-radius: 4px;">
                                <p style="margin: 0; color: #0c5460; font-size: 13px; line-height: 1.5; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">
                                    <strong>What's Next:</strong> Your application PDF has been attached to this email. Our IX team will review your application and you will receive email notifications for any status updates.
                                </p>
                            </div>
