...
<head>
    ...
    <title>IX Application Forwarded</title>
    ...
    <table role="presentation" style="width: 100%; border-collapse: collapse; background-color: #f5f5f5;">
        <tr>
            <td align="center" style="padding: 30px 20px;">
                <table role="presentation" style="max-width: 600px; width: 100%; background-color: #ffffff; border: 10px solid #3498db; border-radius: 4px; overflow: hidden;">
                    <!-- Header -->
                    <tr>
                        <td style="padding: 25px 30px; border-bottom: 2px solid #3498db; background-color: #3498db;">
                            <p style="margin: 0; color: #ffffff; font-size: 22px; font-weight: 600; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">IX Application Status Update</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="margin: 0 0 25px 0; color: #555555; font-size: 15px; line-height: 1.6; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">
                                Your IX application has been reviewed and forwarded to the next stage in the approval process.
                            </p>
                            ...
                            <div style="background-color: #f8f9fa; border-radius: 6px; padding: 25px; margin: 30px 0; border: 1px solid #e0e0e0;">
                                ...
                                <table role="presentation" style="width: 100%; border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <td style="padding: 8px 0; color: #555555; font-size: 14px; font-family: 'Nunito', 'Trebuchet MS', sans-serif;"><strong>Forwarded From:</strong></td>
                                        <td style="padding: 8px 0; color: #2c3e50; font-size: 14px; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">{{ $forwardedFrom }}</td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 8px 0; color: #555555; font-size: 14px; font-family: 'Nunito', 'Trebuchet MS', sans-serif;"><strong>Forwarded To:</strong></td>
                                        <td style="padding: 8px 0; color: #2c3e50; font-size: 14px; font-weight: 600; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">{{ $forwardedTo }}</td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div style="background-color: #e8f4f8; border-left: 3px solid #3498db; padding: 15px; margin: 20px 0; border-radius: 4px;">
                                <p style="margin: 0; color: #0c5460; font-size: 13px; line-height: 1.5; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">
                                    <strong>Status:</strong> Your application is progressing through the approval workflow. You will receive email notifications for any further status updates.
                                </p>
                            </div>
