                ...
                <table role="presentation" style="max-width: 600px; width: 100%; background-color: #ffffff; border: 10px solid #2c3e50; border-radius: 4px; overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 25px 30px; border-bottom: 2px solid #2c3e50;">
                            <p style="margin: 0; color: #2c3e50; font-size: 22px; font-weight: 600; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">NIXI Admin Panel</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            <p style="margin: 0 0 20px 0; color: #333333; font-size: 16px; line-height: 1.6; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">Hello Admin,</p>
                            <p style="margin: 0 0 25px 0; color: #555555; font-size: 15px; line-height: 1.6; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">You have requested to login to the NIXI Admin Panel. Please use the following One-Time Password (OTP) to complete your login:</p>
                            ...
                            <div style="background-color: #ffe6e6; border-left: 3px solid #e74c3c; padding: 15px; margin: 20px 0; border-radius: 4px;">
                                <p style="margin: 0; color: #721c24; font-size: 13px; line-height: 1.5; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">
                                    <strong>Security Notice:</strong> If you did not attempt to login, please secure your admin account immediately and contact the system administrator.
                                </p>
                            </div>
