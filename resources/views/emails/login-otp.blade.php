                ...
                <table role="presentation" style="max-width: 600px; width: 100%; background-color: #ffffff; border: 10px solid #2c3e50; border-radius: 4px; overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="margin: 0 0 25px 0; color: #555555; font-size: 15px; line-height: 1.6; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">You have requested to login to your NIXI Application account. Please use the following One-Time Password (OTP) to complete your login:</p>
                            ...
                            <div style="background-color: #e8f4f8; border-left: 3px solid #3498db; padding: 15px; margin: 20px 0; border-radius: 4px;">
                                <p style="margin: 0; color: #0c5460; font-size: 13px; line-height: 1.5; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">
                                    <strong>Security Notice:</strong> If you did not attempt to login, please secure your account immediately by changing your password.
                                </p>
                            </div>
