                ...
                <table role="presentation" style="max-width: 600px; width: 100%; background-color: #ffffff; border: 10px solid #2c3e50; border-radius: 4px; overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="margin: 0 0 25px 0; color: #555555; font-size: 15px; line-height: 1.6; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">Your profile update request has been approved and your details have been successfully updated.</p>
                            
                            <div style="background-color: #e8f8f0; border-left: 3px solid #27ae60; padding: 20px; margin: 25px 0; border-radius: 4px;">
                                <p style="margin: 0 0 15px 0; color: #2c3e50; font-size: 16px; font-weight: 600; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">Updated Information:</p>
                                ...
                                <p style="margin: 8px 0; color: #555555; font-size: 15px; line-height: 1.6; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">
                                    <strong style="color: #2c3e50;">Email:</strong> <span style="background-color: #f0f0f0; padding: 4px 12px; border-radius: 4px;">{{ $updatedData['email'] }}</span>
                                </p>
                                @endif
                                @if(isset($updatedData['mobile']))
                                <p style="margin: 8px 0; color: #555555; font-size: 15px; line-height: 1.6; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">
                                    <strong style="color: #2c3e50;">Mobile:</strong> <span style="background-color: #f0f0f0; padding: 4px 12px; border-radius: 4px;">{{ $updatedData['mobile'] }}</span>
                                </p>
                                @endif
                            </div>
                            
                            <p style="margin: 25px 0 15px 0; color: #555555; font-size: 14px; line-height: 1.6; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">
                                <strong style="color: #2c3e50;">Note:</strong> Your profile has been updated with the new information. You can now use your updated email and mobile number for all future communications.
                            </p>
                            ...
                            <div style="background-color: #fff9e6; border-left: 3px solid #f39c12; padding: 15px; margin: 20px 0; border-radius: 4px;">
                                <p style="margin: 0; color: #856404; font-size: 13px; line-height: 1.5; font-family: 'Nunito', 'Trebuchet MS', sans-serif;">
                                    <strong>Security Notice:</strong> If you did not request this profile update, please contact our support team immediately.
                                </p>
                            </div>
